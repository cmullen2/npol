...
//Chris altered 26/1/16 to add splitting level of 1, previously splitting level was unspecified, there are other changes search Branch to see 

  fnpolTree->Branch("Inc","TLorentzVector",&fIncMom,64000,0);
  fnpolTree->Branch("SP","TLorentzVector",&fSPMom,64000,0);
  fnpolTree->Branch("SN","TLorentzVector",&fSNMom,64000,0);
  fnpolTree->Branch("RealS","TLorentzVector",&fRealScat,64000,0);
